...
class Clothing extends AbstractProduct implements StockableInterface
{
    ...
    public function __construct(int $id = 0, string $name = '', int $quantity = 0, string $size = '', string $color = '')
    {
    ...
    public function create(): bool
    {
        try {
            ...
            // insert child clothing row using product_id as PK/FK
            ...
            echo "Erreur (Clothing::create): " . $e->getMessage();
            return false;
        }
    }
    public function update(): bool
    {
        ...
        try {
            ...
            // update child clothing row
            $stmt2 = $pdo->prepare("REPLACE INTO clothing (product_id, size, color) VALUES (:product_id, :size, :color)");
            $stmt2->execute([
                ':product_id' => $this->id,
                ':size' => $this->size,
                ':color' => $this->color,
            ...
            echo "Erreur (Clothing::update): " . $e->getMessage();
            return false;
        }
    }
